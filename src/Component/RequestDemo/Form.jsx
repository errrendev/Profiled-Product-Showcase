...
export const Form = () => {
  ...
  return (
    <div className='w-full flex flex-col items-center gap-20 text-center px-3 md:px-7 '>
        ...
        <div className="max-w-2xl w-full mx-auto bg-white p-6 py-10 text-left rounded-lg shadow-md">
